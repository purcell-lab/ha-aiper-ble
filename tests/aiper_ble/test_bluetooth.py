...
from custom_components.aiper_ble import bluetooth_transport as transport
from custom_components.aiper_ble.const import DOMAIN
from custom_components.aiper_ble.coordinator import verified_values
from custom_components.aiper_ble.diagnostics import (
    async_get_config_entry_diagnostics,
)
from custom_components.aiper_ble.probe import (
    EXPECTED_CHARACTERISTIC,
    EXPECTED_SERVICE,
    KEY_EXCHANGE_CHARACTERISTIC,
    Target,
)
from custom_components.aiper_ble.protocol import ProtocolError, query_frame

from .helpers import TARGET
from .test_polling import INFO, OP, OPTIONS, S1, WARN, response, setup
from .test_protocol import frame

PATH = "custom_components.aiper_ble"
...
async def test_all_dp_entities_registered_and_updated_from_full_reply(hass, radio):
    from custom_components.aiper_ble.datapoints import MACHINE_FIELDS
...
async def test_real_helper_uses_runtime_replacement_and_never_reconnects():
    ...
    from custom_components.aiper_ble.transport_diagnostics import (
