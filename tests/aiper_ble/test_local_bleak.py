...
from custom_components.aiper_ble import local_bleak as local
from custom_components.aiper_ble.bluetooth_transport import (
    query_once,
    single_attempt_client_class,
)
from custom_components.aiper_ble.coordinator import LOCAL_BLEAK_SERVICE
from custom_components.aiper_ble.protocol import ProtocolError
